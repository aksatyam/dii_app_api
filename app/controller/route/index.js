...
const scheduleTransRoute = require('./schedule_transcation_master');
const stageTranscationRoute = require('./schedule_transcation_master');
...
router.use('/scheduleTransaction', scheduleTransRoute);
router.use('/stageTransaction', stageTranscationRoute);
